...
{[Mapview](https://github.com/r-spatial/mapview)} is an excellent package for interactive mapping in R that goes a bit beyond ggplot. Other good mapping packages worth checking out are {[tmap](https://github.com/mtennekes/tmap)} and {[mapdeck](https://github.com/SymbolixAU/mapdeck)}.

```{r echo=TRUE, fig.height=8, fig.width=8}
map1 <- mapview(deceased_sf,
        layer.name = "Caribou causes of death",
        zcol = "cause_of_death",
