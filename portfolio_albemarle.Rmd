...
### [Development Pipeline](https://github.com/davidnfox/portfolio/blob/main/pipeline.jpg?raw=true)
```{r}
knitr::include_graphics("https://github.com/davidnfox/portfolio/blob/main/pipeline.jpg?raw=true")
```
